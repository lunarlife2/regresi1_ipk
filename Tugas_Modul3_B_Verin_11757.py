...
st.markdown("""<h1 style="text-align: center; color:#4CAF50">Prediksi IPK - 1757</h1>""", unsafe_allow_html=True)
...
st.markdown("""<h3 class="header-text">Upload File dan Input Nilai</h3>""", unsafe_allow_html=True)
...
if uploaded_file is not None:
    ...
    model_directory = r'D:\atma\Semester 5\ML\Supervised Learning (Praktek)\Model Suprevised Learning (Praktek)\Tugas3_B_11757'
    ...
    if os.path.exists(model_path):
        ...
        st.sidebar.subheader("Masukan Nilai")
        ...
        st.sidebar.subheader("Masukan KKM Nilai")
